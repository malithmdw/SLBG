...
<html>
<head>
<title>SLBG | Sales and Services</title>
<!-- Custom Theme files -->
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="active"><a href="products.php">Sales and Services</a></li>
							...
							<div class="product-right-top">
								...
								<div class="p-right">
									<div class="col-md-6 p-right-left">
										<a href="p-single.html">Title 01- leyland viking 54 seat bus for sale</a>
										<p>desription of item 01- well maintained 54 seat leyland viking bus for sale in embilipitiya. NC-9*** Embilipitiya Colombo.</p>
										<p class="p-call">071 2097337</p>
									</div>
									<div class="col-md-6 p-right-right">
										<h6>12:18 pm -colombo</h6>
										<p>(123) Views</p>
										<span class="p-offer">Rs.2 900 000</span>
									</div>
									<div class="clearfix"> </div>
								</div>
								<div class="clearfix"> </div>
